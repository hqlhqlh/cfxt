		...
		<div class="bgh">
			<div class="page">
				...
				<div class="topxx" style="padding-top: 20px;font-size: 12px;">
					910513201419学员：邹智，欢迎您！ <a href="MyInfo.jsp">我的信息</a> <a
						href="systemMsge.jsp"> 通知</a> <a href="ChangePasswd.jsp">密码修改</a>
		...
		<div class="box mtop" style="margin-top: 50px;">
			<div class="leftbox">
				<div class="l_nav2">
					...
					<div class="cdlist">
						<div>
							<a href="Application.jsp">我要报名</a>
						</div>
						<div>
							<a href="Score.jsp">我的成绩</a>
						</div>
					</div>
					<div class="ta1">
						<strong>学习中心</strong>
					...
					<div class="cdlist">
						<div>
							<a href="StudentMaterial.jsp">资料下载</a>
						</div>
						<div>
							<a href="index.jsp">111111</a>
						</div>
						<div>
							<a href="index.jsp">111111</a>
						</div>
