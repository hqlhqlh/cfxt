...
<div class="cztable">
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td rowspan="9"><div align="center"><img id="pic_face"  height="160" width="120" src="/photo/${user.photo}" style="padding:2px 2px 5px; border:1px #ddd solid;margin-bottom: 30px;"></div>&nbsp;</td>
        </tr>
        <tr>
