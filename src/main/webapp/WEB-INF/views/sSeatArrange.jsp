...
<body>
    ...
    <div class="page">
        <div class="box mtop" style="margin-top: 50px;">
            ...
            <div class="rightbox">
<h2 class="mbx">个人中心 &gt; 监考信息  &gt; 座位安排&nbsp;&nbsp;&nbsp;</h2>       
<div class="morebt">
...
<div class="cztable">
    <div style="padding-bottom:20px;">
        ...
        <tr align="center">
            ...
            <th style="width:40%;">准考证号</th>
            <th>座位号</th>
        </tr>
        
        <c:forEach  items="${list}" var="exam" varStatus="e">
	        <tr align="center">
	            <td style="text-align:center">${e.index+1}</td>
	            <td style="padding-top: 10px;>
	            	<div align="center">
	            		<img id="pic_face"  height="60" width="45" src="/photo/${exam.roomnum}"  style="padding:2px 2px 5px; border:1px #ddd solid;">
	            	</div>&nbsp;
	            </td>
	            <td>${exam.username }</td>
	            <td>${exam.subject}</td>
